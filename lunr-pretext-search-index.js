...
},
{
  ...
  "number": "2.9",
  "title": "Problems",
  "body": " Problems    For the circuit in , calculate the voltage at points A, B, and C if (a) A is the common, (b) B is the common, and (c) C is the common.          In the circuit shown in , calculate the voltages at points A, B, and C.          A fixed resistor and a potentiometer are connected in series across a 5V battery of negligible internal resistance. Calculate the maximum and minimum values of based on possible potentiometer settings. (See for an explanation of potentiometers.)          Calculate the current in .          Calculate the equivalent resistance between points A and B in .          Use the branch method to determine values and directions for and in .          Use the mesh method to determine values and directions for , , and in .          Determine an expression for that results in zero current through resistor . Your expression may only depend on , , , , , and .          Calculate the Thevenin equivalents for the circuit in .          Calculate the Thevenin equivalents for the circuit in .          "
},
{
...
{
  "id": "fig-dc-homework-a7p5",
  "level": "2",
  "url": "sec-dc-homework.html#fig-dc-homework-a7p5",
  "type": "Figure",
  "number": "2.9.8",
  "title": "",
  "body": "     "
