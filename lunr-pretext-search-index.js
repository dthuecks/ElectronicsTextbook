...
},
{
  ...
  "number": "6.3.9",
  "title": "",
  "body": " The frequency response of amplifiers using negative feedback depends on the circuit gain selected through design. As gain drops, bandwidth increases.      f0 = 1.2   A0 = 1e6   A1 = 10   f1 = A0*f0\/A1  G0(x) = A0\/sqrt(1+(x\/f0)^2)   G1(x) = A1 \/ sqrt(1+(x\/f1)^2)      f (Hz)   G_V       G_{V,\\text{open loop}}  G_V = 10       "
},
{
