...
{
  "id": "sub-python-analysis-4",
  "level": "2",
  "url": "sec-diode-circuit-analytic.html#sub-python-analysis-4",
  "type": "Example",
  "number": "4.4.9",
  "title": "Full Wave Rectifier.",
  "body": " Full Wave Rectifier   Let's look at a full-wave rectifier circuit pictured in where we're going to use .    We find KCL equations for the junctions labeled and  . We can also write down expressions for the currents by examining voltage changes across components . Combining - with - , we find that . Using Newton's method in , we'll set and then calculate . Then, we can use Python to estimate the circuit behavior using Newton's method.    "
},
{
  "id": "ch-safety",
  "level": "1",
